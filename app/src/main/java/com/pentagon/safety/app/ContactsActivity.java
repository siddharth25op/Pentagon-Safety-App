...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Use a hashmap
        myContacts.put(KEY_CON1, Objects.requireNonNull(sh.getString(KEY_CON1, "")));
        myContacts.put(KEY_CON2, Objects.requireNonNull(sh.getString(KEY_CON2, "")));
        myContacts.put(KEY_CON3, Objects.requireNonNull(sh.getString(KEY_CON3, "")));
        myContacts.put(KEY_CON4, Objects.requireNonNull(sh.getString(KEY_CON4, "")));
        myContacts.put(KEY_CON5, Objects.requireNonNull(sh.getString(KEY_CON5, "")));
